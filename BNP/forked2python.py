...
X_test = test
print('Training...')
extc = ExtraTreesClassifier(n_estimators=300,max_features= 50,criterion= 'entropy',min_samples_split= 4,
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('extra_treesn300.csv',index=False)