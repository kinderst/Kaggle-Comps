...
names(allData)
#get rid of unimportant features at determined by boruta
allData$v38 <- NULL
allData$v3 <- NULL
allData$v22 <- NULL
allData$v24 <- NULL
...
allData$v52 <- NULL
allData$v125 <- NULL
#allData$v126 <- NULL max = 2.34 so might be important at some point
#91 = same as 107
allData$v91 <- NULL
#allData$v99 <- NULL max > 3
allData$v75 <- NULL
#allData$v27 <- NULL iffy but we will keep for now
allData$v74 <- NULL
allData$v28 <- NULL
allData$v78 <- NULL
